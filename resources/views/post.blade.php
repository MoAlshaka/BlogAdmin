                ...
                <div class="col-md-8 pr-lg-5 pb-5">
                    ...
                    <article class="blog-post">
                        <header class="blog-post-header mb-4">
                            <img src="{{ asset('posts/images/' . $post->image) }}" class="" alt="">
                        </header>

                        <div class="d-flex mb-3 post-meta">
                            <span class="post-date pr-3">Author: <a href="#">John Doe</a></span>
                            <span
                                class="post-date border border-top-0 border-bottom-0 px-3">{{ $post->created_at }}</span>
                            <a href="#">
                                <span class="d-flex align-items-center px-3"><i class="fa fa-comments-o text-3 mr-1"
                        ...
                        <ul class="list-inline mb-0 border border-right-0 border-left-0 py-3">
                            ...
                            @foreach ($tags as $tag)
                                <li class="list-inline-item"><a href="#"
                                        class="badge badge-light badge-sm badge-pill px-3 py-2">{{ $tag }}</a>
                                </li>
                            @endforeach
                                            ...
                                            <div class="comment">
                                                ...
                                                <div class="comment-block">
                                                    <span class="comment-by">
                                                        <strong
                                                            class="comment-author text-color-dark text-4">{{ $comment->name }}</strong>
                                                        <span
                                                            class="comment-date text-color-light-3">{{ $comment->created_at }}</span>
